...
import { getReportType, metricsForOs } from '@/shared/reports/catalog'
import { listLocalizedReportTypes, localizedMetricLabel, localizedReportType } from '@/shared/reports/i18n'
import { customizeReportFromPrompt } from '@/shared/reports/engine/aiCustomize'
import { buildReportSnapshot } from '@/shared/reports/engine/buildSnapshot'
import type {
  ReportSourceMember,
  ReportSourceProject,
  ReportSourceTask,
} from '@/shared/reports/engine/buildSnapshot'
import { defaultConfig } from '@/shared/reports/config'
import { ReportPdfPreview } from '@/shared/reports/components/ReportPdfPreview'
import { downloadReportPdf } from '@/shared/reports/pdf/exportPdf'
import type {
  DateRangePreset,
  MetricId,
  ReportChartId,
