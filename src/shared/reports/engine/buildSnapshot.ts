import { getReportType } from '@/shared/reports/catalog'
import { resolveReportPeriod } from '@/shared/reports/date-ranges'
import { localizedMetricLabel, localizedPdfCopy } from '@/shared/reports/i18n'
import type {
  ChartDatum,
  MetricId,
  ReportChartKind,
