...
export function NotesPage() {
  ...
  const create = useMutation({
    ...
    onSuccess: async (note) => { await qc.invalidateQueries({ queryKey: notesKeys.all }); navigate(`/notes/${note.id}`) },
